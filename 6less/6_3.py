...
random_worker = Position(**worker_data)
print('Имя:', random_worker.name)
print('Фамилия:', random_worker.surname)
print('Должность:', random_worker.position)
print('Имя и фамлия(метод):', random_worker.get_full_name())
print('Общий доход(метод):', random_worker.get_total_income())
